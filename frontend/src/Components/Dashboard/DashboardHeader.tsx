...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({
    ...
    const [dateRange, setDateRange] = useState(() => {
        return {
            startDate: new Date().getTime() - 300000, // Default to 5 minutes ago
            endDate: new Date().getTime(), // Default to now
            range: 'last-5-minutes', // Default range
        };
    });
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            dateChangeHandle(storedLayout?.dateRange.range || 'last-5-minutes');
        }, 1000);
        return () => {
    ...
    const dateChangeHandle = async (value: string) => {
                    ...
                    <Box className="toolbar-right">
                        ...
                        >
                            ...
                            >
                                ...
                                <MenuItem value="last-5-minutes">
                                    Last 5 Minutes
                                </MenuItem>
                                <MenuItem value="last-15-minutes">
                                    Last 15 Minutes
                                </MenuItem>
                                <MenuItem value="last-30-minutes">
                                    Last 30 Minutes
                                </MenuItem>
                                <MenuItem value="last-1-hour">
                                    Last 1 Hour
                                </MenuItem>
                                <MenuItem value="last-2-hours">
                                    Last 2 Hours
                                </MenuItem>
