            ...
            <ul>
                ...
                <div >
                    ...
                    <li onClick={() => handleLinkClick('/addRoom')}>
                        <AddIcon className="speedicon" />Add Room
                    </li>
                    <li onClick={() => handleLinkClick('/addDgset')}>
                        <AddIcon className="speedicon" />Add DG-Set
                    </li>
                    <li onClick={() => handleLinkClick('/addGrid')}>
                        <AddIcon className="speedicon" />Add Grid
                    </li>
                    <li onClick={() => handleLinkClick('/addSwitch')}>
                        <AddIcon className="speedicon" />Add Switch
                    </li>
